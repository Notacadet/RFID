...
*/
class RetrieveProfileTest extends PHPUnit_Extensions_Database_TestCase
{
...
*/    
    ...
    public function testRetrieveProfiles() {
        $resultingTable = $this->getConnection()
            ->createQueryTable("users",
            "SELECT * FROM users");
        
        $expectedTable =  $this->createXmlDataSet("profiles2.xml")
            ->getTable("users");
