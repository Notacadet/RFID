...
*/
class ModelsConnectionTest extends PHPUnit_Extensions_Database_TestCase
{
     ...
     protected function getDataSet()
    {
        ...
        $dataSet->addTable('makes', dirname(__FILE__)."\models_Stale2.csv");
        return $dataSet;
    }
    ...
    public function testGetRowCount()
    {
        ...
        $this->assertEquals(253, $this->getConnection()->getRowCount('models'));
    }
}
?>